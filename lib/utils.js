...
exports.getSuitContextObject = function(Suit, ctx) {
    ...
    Object.defineProperty(suitContext   ,"suit", {
        value: ctx.hasOwnProperty("suit")?ctx.suit:ctx,
        writable: false,
        enumerable: false,
        configurable: true
    });
...
exports.addMochaProperties = function(ctx,mochaContext) {
    getAllProperties(mochaContext).forEach(function(property) {
        var descriptor = Object.getOwnPropertyDescriptors(mochaContext,property) || {
            enumerable: true
        };
        Object.defineProperty(ctx,property,{
            get: () => mochaContext[property],
